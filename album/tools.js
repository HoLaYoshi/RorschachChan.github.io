<script src="\assets\js\APlayer.min.js"> </script>const fs = require("fs");
   const path = "../../photos";
   var qiniu = require("qiniu");
   //需要填写你的 Access Key 和 Secret Key
   qiniu.conf.ACCESS_KEY = 'WHg_aoZB61oK16ecGy2xv62UY_DPFYDSR_dJMF-Y';
   qiniu.conf.SECRET_KEY = 'OxDBBVJ99v1vt8EKaV4T3Un7YPSSd5T0yV_LXr5K';
   //要上传的空间
   bucket = 'jichengtest';
   //构建上传策略函数
